...
{
	IFS0bits.T1IF = 0;
	PORTB = 0x0000; 	// output LOW on RE0, HIGH on RE8
...
{
	IFS0bits.T2IF = 0;
	PORTB = 0x0001; 	// output HIGH on RE0, HIGH on RE8	
...
int main (void){
	TRISB = 0x0000; // Port E is a output port 
	PORTB = 0x0000;	// output HIGH on RE8, low on RE0
