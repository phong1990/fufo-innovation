...
#include "p30f4012.h" // Include this in your MPLAB project under "Header Files" from C:\Program Files (x86)\Microchip\MPLAB C30\support\dsPIC30F\h
...
*          Configure Fuses            *
**************************************/
_FOSC(CSW_FSCM_OFF & FRC);  								// Disable clock monitor, external 10MHz oscillator
...
int main(void)
{
	...
	{
		PDC1 = 691; // This sets the duty cycle, for or servo (or motor) 1875 is neutral.
	}//while
}//main	
...
void Init_PWM(void)
{
	...
	PTPERbits.PTPER = 10000; // Pe0riod Value bits
}	
