...
#define	Fpwm	50			//Tan so PWM = 50Hz
...
//	ADCON1 = 0x0040;		//Timer 3 cham dut lay mau va kich hoat
	...
	ADCON3 = 0x0100;		//Dung 1 TAD cho lay mau, dung clock he thong,
							//TAD = Tcy/2 = 271 ns
...
void Init_MCPWM(void) {
	...
	PDC1 = 7372;			//Khoi tao PWM1 = 10% = 2ms
	PDC2 = 3686;			//Khoi tao PWM2 = 5% = 1ms
	PDC3 = 5529;			//Khoi tao PWM2 = 7.5% = 1.5ms
	PWMCON2 = 0x0F00;		//Special trigger Postscale = 1:16
